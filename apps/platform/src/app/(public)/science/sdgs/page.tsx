        ...
        <div className={`${OUTER} py-16 md:py-24`}>
          ...
          <div className="space-y-6 mb-14">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Tourism is the only economic sector explicitly named in three United Nations
              Sustainable Development Goals (SDG 8.9, SDG 12.b, SDG 14.7). The three pillars of
              this framework map directly and verifiably onto five SDGs.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm">
            ...
            >
              Learn more about the SDGs <ExternalLink className="w-3.5 h-3.5" />
            </a>
            <Link
