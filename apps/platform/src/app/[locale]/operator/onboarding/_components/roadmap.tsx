...
export function RoadmapScreen({
  ...
  const sections = [
    {
      num: "01",
      label: tWelcome("sections.profile.label"),
      desc: tWelcome("sections.profile.desc"),
      done: !!(data.legalName?.trim()),
    },
    {
      num: "02",
      label: tWelcome("sections.p1.label"),
      desc: tWelcome("sections.p1.desc"),
      done: data.totalElectricityKwh != null || data.totalGasKwh != null,
    },
    {
      num: "03",
      label: tWelcome("sections.p2.label"),
      desc: tWelcome("sections.p2.desc"),
      done: data.totalFte != null || data.soloOperator === true,
    },
    {
      num: "04",
      label: tWelcome("sections.p3.label"),
      desc: tWelcome("sections.p3.desc"),
      done: !!data.p3Status,
    },
  ];
