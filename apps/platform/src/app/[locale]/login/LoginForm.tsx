    ...
    try {
      ...
      if (result?.error) {
        ...
        if (callbackUrl && callbackUrl !== "/") {
          ...
          if (roles.includes("admin")) window.location.href = withLocalePath("/admin/dashboard", locale);
          else if (roles.includes("operator")) window.location.href = withLocalePath("/operator/dashboard", locale);
          else if (roles.includes("traveler")) window.location.href = withLocalePath("/traveler/dashboard", locale);
          else window.location.href = selectRoleHref;
        }
      }
    } catch {
