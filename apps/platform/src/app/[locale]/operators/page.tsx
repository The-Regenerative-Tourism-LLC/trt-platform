...
const BAND_OPTION_VALUES = [
  { value: "regenerative_leader", key: "regenerativeLeader", color: "bg-primary" },
  { value: "regenerative_practice", key: "regenerativePractice", color: "bg-primary/80" },
  { value: "advancing", key: "advancing", color: "bg-primary/60" },
  { value: "developing", key: "developing", color: "bg-muted-foreground" },
] as const;
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative z-10 container mx-auto max-w-7xl py-14 md:py-24 px-5 md:px-6 space-y-4">
          ...
          <p className="text-white/50 text-sm">
            {sorted.length === 0
              ? t("hero.noMatch")
              : t("hero.count", { count: sorted.length })}
          </p>
        </div>
      </section>
